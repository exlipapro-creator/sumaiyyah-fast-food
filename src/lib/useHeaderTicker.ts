...
const DEFAULT_FALLBACK: HeaderTickerPayload = {
  ...
  announcements: [
    {
      id: "ann_1",
      text: "TOP KITCHEN LIVE: Authentic Swahili Street Food & Juices Wazi Sasa",
      highlight: "Moto & Safi",
      priority: 1,
      is_active: true,
    },
    {
      id: "ann_2",
      text: "Express Delivery: Posta, Upanga, Kariakoo, Kisutu & Ilala",
    ...
    {
      id: "ann_3",
      text: "Restaurant Hours: 7:00 AM – 11:00 PM Kila Siku",
    ...
    {
      id: "ann_4",
      text: "Corporate Office Catering & Lunch Orders",
